...
var data = {
	...
	"http://hemin.cn/jq/js/jQuery.data":{title:"jQuery.data(element,[key],[value])",type:"核心"},
	...
	"http://hemin.cn/jq/js/jQuery.fx.off":{title:"http://hemin.cn/jq/js/jQuery.fx.off",type:"效果"},
	"jQuery.fx.interval":{title:"jQuery.fx.interva",type:"效果"},
	
	/*Ajax 14*/
	"http://hemin.cn/jq/js/jQuery.ajax":{title:"$.ajax(url,[settings])",type:"Ajax"},
	"load":{title:"load(url,[data],[callback])",type:"Ajax"},
	"http://hemin.cn/jq/js/jQuery.get":{title:"$.get(url,[data],[fn],[type])",type:"Ajax"},
	"jQuery.getJSON":{title:"$.getJSON(url,[data],[fn])",type:"Ajax"},
	"jQuery.getScript":{title:"$.getScript(url,[callback])",type:"Ajax"},
	"http://hemin.cn/jq/js/jQuery.post":{title:"$.post(url,[data],[fn],[type])",type:"Ajax"},
	...
	"http://hemin.cn/jq/js/jQuery.each":{title:"$.each(object,[callback])",type:"工具"},
	"jQuery.extend":{title:"$.extend([d],tgt,obj1,[objN])",type:"工具"},
	"http://hemin.cn/jq/js/jQuery.grep":{title:"$.grep(array,fn,[invert])",type:"工具"},
	"http://hemin.cn/jq/js/jQuery.sub":{title:"jQuery.sub()",type:"工具"},
	"http://hemin.cn/jq/js/jQuery.when":{title:"jQuery.when(deferreds)",type:"工具"},
	"jQuery.makeArray":{title:"$.makeArray(obj)",type:"工具"},
	"http://hemin.cn/jq/js/jQuery.map":{title:"$.map(arr|obj,callback)",type:"工具"},
	...
	"http://hemin.cn/jq/js/jQuery.noop":{title:"http://hemin.cn/jq/js/$.noop",type:"工具"},
	"jQuery.proxy":{title:"$.proxy(fn,c)",type:"工具"},
	"jQuery.contains":{title:"$.contains(c,c)",type:"工具"},
	"http://hemin.cn/jq/js/jQuery.type":{title:"$.type(obj)",type:"工具"},
	...
	"http://hemin.cn/jq/js/jQuery.trim":{title:"$.trim(str)",type:"工具"},
	...
	"http://hemin.cn/jq/js/event.data":{title:"http://hemin.cn/jq/js/eve.data",type:"Event对象"},
	...
	"http://hemin.cn/jq/js/event.type":{title:"http://hemin.cn/jq/js/eve.type",type:"Event对象"},
	"event.which":{title:"eve.which",type:"Event对象"},
	
	/*Deferred 14*/
	"http://hemin.cn/jq/js/deferred.done":{title:"def.done(d,[d])",type:"Deferred"},
	"http://hemin.cn/jq/js/deferred.fail":{title:"def.fail(failCal)",type:"Deferred"},
	...
	"http://hemin.cn/jq/js/deferred.then":{title:"def.then(d,f,[,p])",type:"Deferred"},
	"deferred.promise":{title:"def.promise([ty],[ta])",type:"Deferred"},
	"http://hemin.cn/jq/js/deferred.pipe":{title:"def.pipe([d],[f],[p])",type:"Deferred"},
	...
	/*Callbacks 10*/
	"http://hemin.cn/jq/js/callbacks.add":{title:"cal.add(callbacks)",type:"Callbacks"},
	"callbacks.disable":{title:"cal.disable()",type:"Callbacks"},
	"callbacks.empty":{title:"cal.empty()",type:"Callbacks"},
	"http://hemin.cn/jq/js/callbacks.fire":{title:"cal.fire(arguments)",type:"Callbacks"},
	"callbacks.fired":{title:"cal.fired()",type:"Callbacks"},
	"callbacks.fireWith":{title:"cal.fireWith([c][,a])",type:"Callbacks"},
	"http://hemin.cn/jq/js/callbacks.has":{title:"cal.has(callback)",type:"Callbacks"},
	"http://hemin.cn/jq/js/callbacks.lock":{title:"cal.lock()",type:"Callbacks"},
...
$("#content").prepend("<div class='return'><div class='retLeft'><a href='http://hemin.cn/jq/js/cheatsheet.html' class='pc' title=''>首页</a>&nbsp;&gt;&nbsp;"+hemin.thisName.type +"&nbsp;&gt;&nbsp;"+hemin.thisName.title +"</div><div class='retRight'><a href='http://hemin.cn/jq/js/bugandUpdate.html'>反馈/更新</a></div></div>");
...
$("#content").append("<a id='go_home' title='回到首页' href='http://hemin.cn/jq/js/cheatsheet.html' >首页</a><div id='go_top' title='回到顶部'>顶部</div>");
